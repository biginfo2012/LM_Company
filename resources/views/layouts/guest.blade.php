...
<footer class="footer footer-static footer-light position-absolute" style="bottom: 20px; width: 100%">
    <p class="clearfix mb-0 d-flex" style="font-size: 11px"><span class="float-md-start d-block d-md-inline-block mt-25" style="margin: auto">Copyright &copy; 2022 LaborManager<span
                class="d-sm-inline-block">, All rights Reserved</span></span></p>
</footer>
